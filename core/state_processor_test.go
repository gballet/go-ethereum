...
var (
	...
	intrinsicContractCreationGas, _    = IntrinsicGas(code, nil, true, true, true)
	...
	intrinsicCodeWithExtCodeCopyGas, _ = IntrinsicGas(codeWithExtCodeCopy, nil, true, true, true)
)
