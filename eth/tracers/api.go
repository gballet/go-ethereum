...
func (api *API) traceChain(start, end *types.Block, config *TraceConfig, closed <-chan error) chan *blockTraceResult {
	...
	go func() {
		...
		for number = start.NumberU64(); number < end.NumberU64(); number++ {
			...
			core.PreExecution(ctx, next.BeaconRoot(), block.Hash(), api.backend.ChainConfig(), evm, next.Number(), next.Time())
			evm.Release()
...
func (api *API) IntermediateRoots(ctx context.Context, hash common.Hash, config *TraceConfig) ([]common.Hash, error) {
	...
	core.PreExecution(ctx, block.BeaconRoot(), parent.Hash(), chainConfig, evm, block.Number(), block.Time())
...
func (api *API) traceBlock(ctx context.Context, block *types.Block, config *TraceConfig) ([]*txTraceResult, error) {
	...
	// Run pre-execution system calls
	core.PreExecution(ctx, block.BeaconRoot(), parent.Hash(), api.backend.ChainConfig(), evm, block.Number(), block.Time())
