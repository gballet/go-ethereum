...
func (miner *Miner) prepareWork(genParams *generateParams) (*environment, error) {
	...
	env, err := miner.makeEnv(parent, header, genParams.coinbase, state)
	if err != nil {
...
func (miner *Miner) makeEnv(parent *types.Header, header *types.Header, coinbase common.Address, state *state.StateDB) (*environment, error) {
